...
const Layout = ({
  ...
  const handleRoleChange = async (e) => {
    ...
    switch (newRole) {
      ...
      case "HoSP":
        ...
        break;
      case "Lecturer":
        email = "lecturer@icss.com";
        break;
      case "Student":
        email = "student@icss.com";
        break;
      default:
        return;
    }
  ...
  // ✅ Only Program Manager/Admin can see Rooms
  const canSeeRooms = currentUserRole === "admin" || currentUserRole === "pm";
    ...
    <div className="app-container">
      <aside className="sidebar">
        ...
        <div className="sidebar-nav">
          ...
          {canSeeRooms && <NavLink id="rooms" icon="" label="Rooms" />}
        ...
        <div
          ...
          style={{ borderTop: "1px solid #334155", padding: "20px" }}
        >
          <label
            style={{
              fontSize: "0.75rem",
